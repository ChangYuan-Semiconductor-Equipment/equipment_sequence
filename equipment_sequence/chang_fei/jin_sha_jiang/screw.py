...
class Screw(HandlerPassive):
    ...
    def get_carrier_info_front(self, call_back: dict):
        ...
        self.set_dv_value_with_name("is_allow_carrier_in_front", 1)
        self.set_dv_value_with_name("product_code_list_front_reply", ["product_1", "product_2"])
        self.set_dv_value_with_name("frame_code_list_front_reply", ["frame_1", "frame_2"])
        self.set_dv_value_with_name("product_state_list_front_reply", [2, 2])
    ...
    def get_carrier_info_back(self, call_back: dict):
        ...
        self.set_dv_value_with_name("is_allow_carrier_in_back", 1)
